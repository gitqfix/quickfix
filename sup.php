...
<a href="login.php" class="btn btn-success btn-lg active" role="button" aria-pressed="true">Voltar</a></div>
<?php

include_once("dbconnect.php"); //chamar a conexao
